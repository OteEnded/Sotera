...
const install = await installComponents(runtime, PERSONA_CONFIG, {
  ...
  hostProvides: ['memory.v2', 'search', 'serviceInfo', 'schedules', 'todo', 'todoStore', 'interaction', 'interactionStore', 'conversationSearch', 'reflection', 'workingMemory', 'ownMemory', 'intention', 'lesson', 'selfHistory', 'disclosure', 'conversationRetrieval', 'retention'],
