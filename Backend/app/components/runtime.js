...
const install = await installComponents(runtime, PERSONA_CONFIG, {
  ...
  // `corrections` (2026-08-26): the explicit historical gate for repudiated beliefs. Late-bound per
  // request like `ownMemory` — see corrections-host.js for why the exclusion lives in the store and the
  // door lives here.
  hostProvides: ['memory.v2', 'search', 'serviceInfo', 'schedules', 'todo', 'todoStore', 'interaction', 'interactionStore', 'conversationSearch', 'reflection', 'workingMemory', 'ownMemory', 'intention', 'lesson', 'selfHistory', 'disclosure', 'conversationRetrieval', 'retention', 'corrections'],
