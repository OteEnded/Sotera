...
### ⏭⏭ **RESUME HERE — 2026-08-25, ~16:15. ✅ B3 `e075590` · **CONVERSATION RETRIEVAL** `34428c0` · **REVISIT LIFECYCLE** built (mig 025). ⏭⏭ **NEXT IS A DECISION, NOT CODE: THE BACKGROUND-REVISIT AUTHORITY MODEL.** Ote: *“Reading/revisiting a conversation and writing memory from that conversation are two separate acts.”* Present **source authority · cognitive actor · memory owner** and what each choice costs — ⛔ do NOT assume the revisited room's owner is the cognitive owner. **His order: revisit lifecycle → AUTHORITY DECISION → passive worker → B4 salience → seek_advice.** ⛔ The passive worker stays OFF until he rules.
