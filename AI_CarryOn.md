...
### ⏸ **NOT BUILT, awaiting his word:** D-2 re-grain intentions to the room (**the one measured leak**) · D-10 state the GRAIN in persona-owned reads · D-11 scopeAwareness-as-trace · D-12 is disclosure a property or a judgement · D-8 ⚠️ **amends ratified constraint #4**. ⛔ L3 · root-wide disclosure · L4 · tier B all still unbuilt.
