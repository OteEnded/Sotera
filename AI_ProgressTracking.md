...
- ⚠️ **Docs note:** the RFC, the PLAN and the ANALYSIS live at workspace root `Reference/docs/`, which is **not a git repo** — so they never appear in a Sotera commit and are not versioned. Worth knowing before assuming a commit captured them.
